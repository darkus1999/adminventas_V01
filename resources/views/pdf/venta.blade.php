...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo2.png" alt="Queen Burger" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>{{ str_replace('_',' ', config('app.name')) }}</b><br>{{ trans( 'venta.ubicacion' ) }}<br>Telefono: {{ trans( 'venta.telefono' ) }}<br>Email: {{ trans( 'venta.email' ) }}
                </p>
            </div>
            <div id="fact">
        ...
        <footer>
            <div id="gracias">
                <p><b>{{ trans( 'venta.agradecimiento' ) }}</b></p>
            </div>
        </footer>
    </body>
</html>